...
const seedProductReviews = () => db.Promise.map([
  {body: 'super dope product!!! something something something', stars: '5', product_id: 2, user_id: 2},
  {body: 'Beautiful Ring!! something something somethingsomething something ', stars: '4', product_id: 4, user_id: 4},
  {body: 'aweful worst product ever something something somethingsomething', stars: '1', product_id: 3, user_id: 12},
  {body: 'Amazing! something somethingsomethingsomething something something something something something ', stars: '5', product_id: 5, user_id: 8}
